...
out = Path('/Users/a1-6/Downloads/WPS重绘/根据3图重绘_原图+可编辑覆盖层.pptx')
...
def add_box(x, y, w, h, text, fill=None, line=BLUE, font=16, rounded=True, line_w=1.7):
...
add_text(60, 24, 560, 26, '底层是原图；上层对象可编辑、可拖动、可删除', 8, RGBColor(160,170,186))
